...
x=eval(input("Enter the item to be searched:"))
b=False
...
while True:
    try:
        value = input("Enter input  (ctrl + z  to  stop)  :  ")
        if value.lower() == "true":
            num = True
        ...
        print("Invalid input. Please enter a number or boolean (True/False).")
if count > 0:
    average = total / count
