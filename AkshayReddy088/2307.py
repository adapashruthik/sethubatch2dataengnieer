...
How  to  print  number  of  keywords # print(len(keyword.alist))
How  to  print  type  of kwlist  # print(type(keyword.alist))
print(keyword . kwlist) # it will print all the reserved keywords in Python
