...
a = 35
print(id(a)) # address of the object 'a' ex:- 1000
...
print(a) # 35.6
b = True
print(id(b)) # address of the object 'b' ex:- 200
b = False
print(id(b)) # address of the object 'b' ex:- 2000
c = None
...
b = (10 , 20 , 15 , 18)
print(id(b)) # address of the object 'b' ex:- 3000
b[2] = 19 # error
b = (30 , 40 , 35 , 32)
print(id(b)) # address of the object 'b' ex:- 4000
c = range(5)
print(id(c)) # address of the object 'c' ex:- 5000
c[3] = 10 # error
c = range(5) 
print(id(c)) # address of the object 'c' ex:- 5000
