...
print('Two'); # Two
print('Three'); # Three
print('Hyd')  ;   print('Sec')  ;  print('Cyb') # Hyd <nextline> Sec <nextline> Cyb <nextline>
...
print(floor(3.5)) # error as there is no float function in current module 
print(ceil(3.5)) # error as there is no ceil function in current module
...
print(gcd(5 , 15)) # error as there is no gcd function in current module
...
print(keyword . kwlist) # error as module is not imported
...
print(kwlist) # error as members of module are not imported
