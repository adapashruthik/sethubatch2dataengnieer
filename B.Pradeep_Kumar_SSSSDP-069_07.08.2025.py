...
try:
    ...
    if num:
        ...
        print("Largest String is:", max(a))
    else:
        print("Inputs Not be an Number and String")
except ValueError:
    print("Enter Atleast 2 Vales")
...
try:
    if len(argv) <= 2:
        print("Pls send atleast 2 inputs")
    else:
        numbers = True
        strings = True
        ...
        print("List a:", a)
        print("Ascending Order is", sorted(a))
...
print('iniv'   not   in   'Srinivas')  # Error
...
if len(a)>=2 and len(b)>=2:
    x=print(f"Result :{a[0:2]+b[2:]} {b[0:2]+a[2:]}")
else:
...
print(f"String  at  even  indexes  :{a[::2]}")

print(f"String  at  Odd  indexes  :{a[1::2]}")
...
print(len('A2#'))  #  3
print(len(3456))  #  4
print('Sec'. len())  #  Error Due to .len not accepted
