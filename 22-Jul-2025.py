...
z = x + y * 6
print(z)         #34
25 = a           #Error Can't assign literal here
a + b = x + y    #Error expression can't contain assignment 
print()

# Find outputs (Home work)
a = b = c = 25
print(id(a))      #Address of object of int 25
print(id(b))      #Address of object of int 25
print(id(c))      #Address of object of int 25
...
x = [1 , 2 , 3 , 4]
y = [1 , 2 , 4 , 3]
print(x == y)          #False order matter in list
a = (4 , 1 , 3 , 2)
b = (4 , 2 , 3 , 1)
print(a == b) #False
p = {1 , 2 , 3 , 4}
q = {4 , 1 , 3 , 2}
print(p == q)         #True Sets ignore order
m = range(5)
n = range(5)
print(m == n)        #True
print()
