...
print(eval('25'))# string object 25 converted to integer 25
...
cyb = 10.8
print(eval('cyb')) #10.8
print(eval(cyb)) #Error due to argument must be in string 
...
print(eval(' ')) #Error
 ...
 # What  is  the  advantage  of  eval(input()) ? we can change string object to any object 
x = eval(input('Enter  any  input  :  ')) #input from  keyboard ex 10
...
print(len(a))#3
print(a) #hyd
b = eval(input('Enter   any  string  : '))# ex : 'bye'
print(len(b)) #3
print(b) #bye
...
print('Sec') #Sec
print()#nothing printed and moved to nextLine
print('Cyb')#Cyb
