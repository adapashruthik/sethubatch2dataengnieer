...
a, b, c = 25, 10.8, 'Hyd'
print(F'{a}  \t   {b}   \t  {c}')			# output: 25   	   10.8   	  Hyd 			: inserts object values directly with tab space
print(F'a = {a}  \t  b  =  {b}  \t  c  =  {c}')		# output: a = 25  	  b = 10.8  	  c = Hyd 	: labels printed with values with tab space
...
# 4) Write  a  program  to  determine  sum , difference , product , quotient , largest  and smallest  of  two  numbers. also  find  remainder,  sqrt  of  first  input , power, gcd  and  factorial  of  first  input
...
# 7) Write  a  program  to  print   '>'  if  1st  input  >  2nd  input, '<'  if  1st  input <  2nd  input  and '='  if  inputs  are  same
...
temp = x   # temp stores x (10)
x = y   # x gets value of y (25)
y = temp   # y gets value of temp (10)
...
# 11) Write  a  program  to  determine  area  and  perimeter  of  rectangle
...
# 12) Write  a  program  to  determine  volume  of  a  sphere
...
# 13) Write  a  program  to  determine  simple  interest  and  compound  interest
...
# 14) Write  a  program  to  swap  values  of  two  objects  without  using  3rd  object Hint: One  addition  and  two  subtractions
...
# 15) Write  a  program  to  swap  values  of  two  objects  without  using  3rd  object Hint: One  multiplication  and  two  divisions
