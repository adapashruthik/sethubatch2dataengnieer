...
print(floor(3.5)) # throws error because math function is not there it searchs in current program
print(ceil(3.5)) # throws error because math function is not there it searchs in current program
...
print(keyword.kwlist) # if we import keyword module then it will give list of keywords otherwise error
