...
match  i:
	case  1:
		print('One')
	case  _:
		print('None of   the  above')		# We cannot use underscore at middle of program
	case  2:
		print('Two')
print('Bye')
...
match  m:
	case  1:
		print('One')
	case  _:
		print('Hello')				# We cannot use underscore at middle of program
	case  _:
		print('Bye')
print('End')
...
while  True:
	print('Hello')
print('Bye')				# Loop continuously executes
...
# Find  outputs  (Home  work)
How  to  print  each  element  of  list  [10 , 20 , 15 , 18]  with  for  loop		# for x in [10, 20, 15, 18]:
    											#     print(x)
print()
How  to  print  each  character  of   string  'Hyd'  with  for  loop			# for x in 'Hyd':
											#     print(x)
print()
...
How  to  print  each  element  and  the  corresponding  index  with  index  based  for  loop					# for i in range(len(a)):
																	print(i, a[i])
print('For each loop')
How  to  print  each  element  and  the  corresponding  index  with  for  ...  each  loop (Do  not  use  2nd  variable)		# for i in enumerate(a):
																	print(i)
...
How   to  print  each  element  of  list  in  reverse  order  with  indexed  based  for  loop						# for i in range(len(a) - 1, -1, -1):
    																		print(a[i])
How   to  print  each  element  of  list  in  reverse  order  with  for  each  loop  (Do  not  use  2nd  variable  and  slice)		# print('For each loop')
																	  for i in reversed(a):
    																		print(i)
