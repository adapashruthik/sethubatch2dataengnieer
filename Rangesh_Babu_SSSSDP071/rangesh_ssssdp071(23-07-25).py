...
print(floor(3.5)) #error:math.floor() 
print(ceil(3.5))#error:math.ceil() 
...
print(gcd(5 , 15))  #error:math.gcd() members are imported by import statement 
...
# Find  outputs 
from keyword import * #How  to  import   kw  list 
...
print(keyword . kwlist) #error:module is not imported module members are imported 
...
print(kwlist) #error:module is imported but not module members. 