...
No continue keyword in if statement
...
No break keyword in if statement
...
nums=[10,20,15,12,18,15,19,14,15,14]
x=int(input("Enter the element to search:"))
count=0
for i in range(len(nums)):
if nums[i]==x:
...
print("Enter values (Ctrl + Z to stop on Windows, Ctrl + D on Unix):")
