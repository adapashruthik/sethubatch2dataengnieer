...
''' 10) Write  a  program  to  search  for  an  element  in  the  list  without  using  in  operator  and
...
'''
#11) Write  a  program  to  search  for  an  element  in  the  list  and  print  index  of  each  element
...
Hyd
sec : 0
#Error as it is a Invalid syntax
'''



''' 14) Write  a  program to  determine  average  of  inputs  which  are  terminated  with  ctrl + z
