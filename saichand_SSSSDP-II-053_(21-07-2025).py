...
How  to  print  each  key  of  dict  'a'						# print(list(a.keys()))
print('Values  of  dictionary')								# Values  of  dictionary
How  to  print  each  value  of  dict  'a'						# print(list(a.values()))
print('All  the  tuples  of  dict_items   object')					# All  the  tuples  of  dict_items   object
How  to  print  each  tuple  of  the  list  in  dict_items  object			# print(list(a.items()))
...
a = 35
print(id(a))		# Address of 'a' may be 2050
...
# Find  outputs (Home  work)
a = 25.7
print(id(a))		# Address of 'a' may be 3000
print(a)		# 25.7
a = 35.6
print(id(a))		# Address of 'a' may be 3050
print(a)		# 35.6
b = True
print(id(b))		# Address of 'a' may be 4000
b = False
print(id(b))		# Address of 'a' may be 4040
c = None
print(id(c))		# Address of 'a' may be 4050
c = None
print(id(c))		# Address of 'a' may be 4050
...
#  Find  outputs  (Home  work)
a = 'Hyd'
print(id(a))			# Address of 'a' may be 5000
a[1] = 'e'			# Error
a = 'Sec'
print(id(a))			# Address of 'a' may be 5020
b = (10 , 20 , 15 , 18)
print(id(b))			# Address of 'a' may be 5030
b[2] = 19			# Error
b = (30 , 40 , 35 , 32)
print(id(b))			# Address of 'a' may be 5040
c = range(5)
print(id(c))			# Address of 'a' may be 5060
c[3] = 10			# Error
c = range(5)
print(id(c))			# Address of 'a' may be 5080
