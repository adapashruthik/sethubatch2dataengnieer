...
How  to  print  kwlist				# print(kwlist)		----> print all the keywords
How  to  print  number  of  keywords		# print(len(kwlist))	----> 35
How  to  print  type  of kwlist			# print(type(kwlist)	----> < class 'list'>
...
How  to  print  kwlist				# print(keyword.kwlist)			----> print all the keywords
