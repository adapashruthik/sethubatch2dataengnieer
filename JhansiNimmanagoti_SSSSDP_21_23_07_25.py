...
print(floor(3.5))#NameError: name 'floor' is not defined. Did you mean: 'float'?
print(ceil(3.5))#NameError: name 'floor' is not defined. Did you mean: 'float'?
#GCD fumction
import math
...
#list of Keywords in python using import statement
import keyword
...
key_wordslist=keyword.kwlist
print(len(key_wordslist))#35
#List of keywords using from statement
from keyword import*
