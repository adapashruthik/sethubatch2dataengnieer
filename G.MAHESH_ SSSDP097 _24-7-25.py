...
print(eval('print("Hyd")'))	# here firstly eval(('print("Hyd")')) is executed then "Hyd" is printed then moves 
to next line and also returns None value so print('None') is None 
output: Hyd
	None
...
print(a , b , c , sep = ',,,')							
print(a , b , c , sep = ':::' , end = '\t\t\t')
print(a , b , c)					# when only end is given next output will comes in same line, sep means separate object with anything we give, \t tab space

'''
# total output: 	25 10.8 Hyd---25,,,10.8,,,Hyd
			25:::10.8:::Hyd<tab><tab><tab>25 10.8 Hyd
'''
