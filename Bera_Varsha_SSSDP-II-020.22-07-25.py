...
# print(range(4) | range(5))#unsupported operand type(s) for |: 'range' and 'range'
print([10 , 20]  |  [30 , 20])#unsupported operand type(s) for |: 'list' and 'list'
...
a = b = c = 25
print(id(a))#140737264186920
print(id(b))#140737264186920
print(id(c))#140737264186920
