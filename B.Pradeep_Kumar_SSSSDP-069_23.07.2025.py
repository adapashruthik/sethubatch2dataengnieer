...
print(floor(3.5))  #  Error due to we imported only math module
print(ceil(3.5))  #  Error due to we imported only math module
...
print(gcd(5 , 15))   #  Error due to we imported only math module
...
# Find  outputs
How  to  import   kw  list  print  # import keyword
