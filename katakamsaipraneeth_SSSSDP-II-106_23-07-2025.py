...
a = 25 # Ref 'a' is pointed to int obj 
print(++a)  #  +(+a) = +a  =  25
...
How  to  import   keyword  module # import keywords
How  to  print  kwlist # print(keywords.kwlist)
How  to  print  number  of  keywords # print(len(keywords.kwlist))
