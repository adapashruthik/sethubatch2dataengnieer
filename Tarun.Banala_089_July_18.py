#Name: BANALA TARUN        18-07-2025     HOME WORKS


a = [25, 10.8, 'Hyd', True, 3 + 4j, None, 'Hyd', 25]
print(a)        # Print the entire list is  [25, 10.8, 'Hyd', True, (3+4j), None, 'Hyd', 25]
print(*a)       #Print the unpacked list elements 25 10.8 Hyd True (3+4j) None Hyd 25
print(type(a))#Print the type of 'a' is <class 'list'>
print(id(a))    # Print the  address of object 'a' is may be 10,000
print(len(a))  # Print the length of the list is 8
a[2] = 'Sec'  #insert the element at index 2 then  [25, 10.8, 'Sec', True, (3+4j), None, 'Hyd', 25]
print(a)        #[25, 10.8, 'Sec', True, (3+4j), None, 'Hyd', 25]
print(a[2:5]) # Print a slice from index 2 to 4 is  ['Sec', True, (3+4j)]
...
a = a * 2
# New tuple created by repeating → (10, 20, 30, 10, 20, 30)
