...
x = eval(input('Enter  any  input  :  '))		# Enter any input : 25 (or) 10.8
print(type(x))						# <class 'int'> (or) <class 'float'>
print(x)						# 25 (or) 10.8
...
a = input('Enter  any  string  :  ')		# Enter any string : sai
print(len(a))					# 3
print(a)					# sai
b = eval(input('Enter   any  string  : '))	# Enter any string : chand
print(len(b))					# 5
print(b)					# chand
...
print(a , b , c , sep = '\t')			# 25 <tabspace> 10.8 <tabspace> Hyd
print(a , b , c , sep = '---')			# 25---10.8---Hyd
print(a , b , c , sep = '\n')			# 25
						# 10.8
						# Hyd
...
# 25:::10.8:::Hyd <tabspace><tabspace><tabspace> 25 10.8 Hyd
...
print('%9.1f'  %a)	#  < space>10.9
print('%10.3f'  %a)	# < spaces>10.927
print('%.2f'  %a)	# 10.93
