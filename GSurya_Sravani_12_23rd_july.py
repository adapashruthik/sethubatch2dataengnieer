...
print('Two');#Two
print('Three');#Three
print('Hyd')  ;#Hyd   print('Sec')  ;  print('Cyb')#Sec #Cyb
...
print(keyword . kwlist)#print(type(keyword.kwlist))



 #  Find  outputs  (Home  work)
How  to  import   keyword  keyword module# import keyword
How  to  print  kwlist#print(keyword.kwlist)
How  to  print  number  of  keywords#print(kwlist)#print(type(keyword.kwlist))
