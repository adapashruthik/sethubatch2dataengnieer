...
print(type(keyword.kwlist))  # <class 'list'># How to print type of kwlist
print(keyword.kwlist)  # prints the keyword list again
...
print(len(keyword.kwlist))  # prints total number of 
