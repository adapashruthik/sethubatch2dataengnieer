...
b = (10 , 20 , 15 , 18)
print(id(b))#reference of object list
b[2] = 19 #error because tuple is fixed and immutable
b = (30 , 40 , 35 , 32)
print(id(b))#refrence of another object list
c = range(5)
...
c =  {10 : 20, 30 : 40}
d =  {10 : 20, 30 : 40}
print(c  is  d)#false because different lists are created and list is mutable
e = (10 , 20 , 15 , 18)
f = (10 , 20 , 15 , 18)
print(e  is  f) #true because tuple is immutable once created cannot be changed
g = {10 , 20 , 15 , 18}
h = {10 , 20 , 15 , 18}
print(g  is  h)#false because tuple is mutable 
# Find outputs (Home work)
...
print(7 // 0)#error
print(7 % 0)#error
[12:14, 7/21/2025] +91 99482 50500: # ** operator demo program
print(3 ** 4)#81
print(10 ** -2)#0.01
print(4 * 3 * 2)#24
