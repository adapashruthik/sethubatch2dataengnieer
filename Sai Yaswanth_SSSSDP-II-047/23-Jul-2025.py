...
#  abs()  function  demo  program from  builtins  import  abs
...
#  max()  and  min()   functions  demo  program from  builtins  import   max , min
...
# pow()  function  demo  program from  builtins  import  pow
