...
print(math . gcd(-18 , -27)) # 9 ######## 18 = 3 * 3*2*3 == 6
...
print(pow(4 , pow(3 , 2))) ### (4,pow(9)) = 4 **9 =
import  builtins
...
# Find  outputs
How  to  import   kwlist  ##import keyword
...
print(keyword . kwlist) ## error due to import module is not present
...
How  to  print  number  of  keywords  ## print(len(keyword.kwlist))
How  to  print  type  of kwlist ## print(type(keyword.kwlist))
print(kwlist) # error no import module
