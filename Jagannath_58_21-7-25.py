...
How  to  print  dictionary  with  print()  function                              print('Keys  of  dictionary')
{10,20,15,18}
How  to  print  each  key  of  dict  'a'                                         print('Values  of  dictionary')
How  to  print  each  value  of  dict  'a'                                       {'Ramesh','kiran','Amar','Sita'}
print('All  the  tuples  of  dict_items   object')                               {(10:'Ramesh'),(20:'Kiran'),(15:'Amar'),(18:'Sita')}
How  to  print  each  tuple  of  the  list  in  dict_items  object
print('Elements  of  each   tuple')                                              {(Ramesh),(Kiran),( Amar),(Sita)}
