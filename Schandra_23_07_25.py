...
: # Find  outputs
How  to  import   kw  list              # import key word
How  to  print  kwlist                  # print (key word,kwlist)
How  to  print  number  of  keywords    # print(len(keywor,kwlist))
...
How  to  print  number  of  keywords   # print(len(keywor,kwlist)) 
How  to  print  type  of kwlist        # print(type(keyword,kwlist)) 
print(kwlist)                          # error#  ++  and  --  operators  demo  program
a = 25
print(++a)  #  +(+a) = +a  =  25
print(a++)   #  (a+)+  =  a+ =  25+  throws   error
print(a++1)  #  a + (+1)  =  a +  1 = 25 + 1  = 26
